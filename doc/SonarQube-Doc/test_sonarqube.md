# مقدمه
این نرم‌افزار یک ابزار کنترل کننده کیفیت کد است. این نرم‌افزار کد‌های برنامه را دریافت کرده و تحلیل می‌کند و گزارش‌هایی را برای کیفیت کدی که نوشته شده است، ارائه می‌دهد.
...
اگر از ابزار‌های CI استفاده می‌کنید، می‌توانید اجرای آن را بر عهده این ابزار‌ها مانند Jenkins گذاشت که فرآیند بررسی را به صورت اتوماتیک انجام دهد.
